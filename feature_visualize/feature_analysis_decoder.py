...
def process_images_in_folder(folder_path, model, save_dir):
    ...
    for image_path in image_paths:
        ...
        with torch.no_grad():
            student_intermediate_feature, compress_feat = model.feature_visualize_with_path1(img_tensor, reshape_to_image=False)
...
save_dir = "./feature_visualize/decoder_feature_analysis_output"
