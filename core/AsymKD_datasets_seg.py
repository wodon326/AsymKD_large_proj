...
class TartanAir(StereoDataset): #../../datasets/AsymKD
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/AsymKD', keywords=[]):
...
class KITTI(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/AsymKD/kitti/kitti2015', image_set='training'):
...
class KITTI2012(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/AsymKD/kitti/kitti2012', image_set='training'):
...
class MegaDepth(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/AsymKD/MegaDepth'):
...
class HRWSI(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/AsymKD/HRWSI'):
...
class BlendedMVS(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/AsymKD/BlendedMVS'):
...
class VKITTI(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/vkitti'):
...
class Hypersim(StereoDataset):
    def __init__(self, seg_any_predictor:SamPredictor, aug_params=None, root='../../datasets/Hypersim'):
...
def fetch_dataloader(args, seg_any_predictor:SamPredictor, rank, world_size):
    ...
    train_loader = data.DataLoader(train_dataset, batch_size=args.batch_size, drop_last=True, collate_fn=collate_fn, num_workers = 8, sampler = sampler, pin_memory=True, persistent_workers=True)
