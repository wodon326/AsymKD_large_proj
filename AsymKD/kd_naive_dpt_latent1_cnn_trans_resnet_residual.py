...
from AsymKD.resnet_cnn_module import Residual_Adapter
...
class Asymkd_kd_naive_dpt_latent1_resnet_adapter_residual(nn.Module):
    def __init__(self, encoder='vits', features= 64, out_channels= [48, 96, 192, 384], use_bn=False, use_clstoken=False, localhub=True):
        super(Asymkd_kd_naive_dpt_latent1_resnet_adapter_residual, self).__init__()
        
        assert encoder in ['vits', 'vitb', 'vitl']
        print('Asymkd_kd_naive_dpt_latent1_resnet_adapter_residual')
    ...
    def freeze_kd_naive_resnet_adapter_dpt_latent1_with_kd_style(self):
