...
class AsymKD_kd_naive_latent1_avg_ver(nn.Module):
    ...
    def forward(self, x):
        ...
        intermediate_feature = self.pretrained.get_first_intermediate_layers(x, 4, return_with_cls_token = True)
        patch_h, patch_w = h // 14, w // 14

        features = self.pretrained.get_intermediate_layers_start_intermediate(intermediate_feature[:, 1:], 3, return_class_token=False)
